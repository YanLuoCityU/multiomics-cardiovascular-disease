...
write.csv(metabolites, "your path/results/Table/Supplemetanry Table 2_metabolomics.csv", row.names = F)
...
write.csv(proteins, "your path/results/Table/Supplemetanry Table 3_proteomics.csv", row.names = F)
...
# CVD event distribution + Followup information + CVD-free survival
...
f9_clin <- ggplot(
  ...
  scale_y_continuous(expand = c(0, 0), limit = c(0.45, 0.91), breaks = c(0.5, 0.7, 0.9)) +
  coord_flip()
...
# PANEL-based vs ASCVD and SCORE2
...
models <- c(
  "ASCVD", "PANEL", "PANELPRS", "PANELMet", "PANELPro", 
  "PANELPRSMet", "PANELPRSPro", "PANELMetPro", "PANELPRSMetPro")

dat <- cindex_raw %>%
  filter(outcome != "Major adverse cardiovascular events" & model %in% models) %>%
  group_by(outcome, fold) %>% 
  mutate(delta_cindex = cindex - cindex[model == "ASCVD"]) %>%
  ungroup() %>%
  group_by(outcome, model) %>%
  summarise(
    mean_delta_cindex = mean(delta_cindex, na.rm = TRUE),
  ...
  mutate(
    model = factor(
      model, levels = rev(models),
      labels = rev(c("ASCVD", "PANEL", "+PRS", "+MetScore", "+ProScore", "+PRS +MetScore", "+PRS +ProScore", "+MetScore +ProScore", "+PRS +MetScore +ProScore"))),
    model_italic = ifelse(!model %in% c("ASCVD", "PANEL"), glue("*{model}*"), glue("{model}")),
    model_italic = factor(model_italic, levels = rev(c("ASCVD", "PANEL", "*+PRS*", "*+MetScore*", "*+ProScore*", "*+PRS +MetScore*", "*+PRS +ProScore*", "*+MetScore +ProScore*", "*+PRS +MetScore +ProScore*"))),
    outcome = factor(
      outcome, 
      levels = c("Coronary artery diseases", "Stroke", "Heart failure", "Atrial fibrillation", "Ventricular arrhythmias", "Peripheral artery diseases", "Abdominal aortic aneurysm", "Vein thrombosis", "Cardiovascular death"),
      labels = c("CAD", "Stroke", "HF", "AF", "VA", "PAD", "AAA", "VTE", "CVDeath")
      ),
    color = ifelse(model == "ASCVD", "white", "#F39B7FCC")
  )

#### Plotting ####
f1_panel_ascvd <- ggplot(
  dat %>% filter(outcome == "CAD"), 
  aes(x = model_italic, y = mean_delta_cindex, color = color)
  ) +
  geom_hline(
  ...
  scale_y_continuous(expand = c(0, 0), limit = c(-0.02, 0.09), breaks = c(0, 0.04, 0.08), labels = c("0", "0.04", "0.08")) +
  coord_flip() + 
  annotate("text", x = 9, y = 0, size = 4, color = "black", label = "Baseline", hjust = -.1)

f2_panel_ascvd <- ggplot(
  dat %>% filter(outcome == "Stroke"), 
  aes(x = model_italic, y = mean_delta_cindex, color = color)
  ) +
  geom_hline(
  ...
  scale_colour_identity() +
  scale_y_continuous(expand = c(0, 0), limit = c(-0.03, 0.11), breaks = c(0, 0.05, 0.10), labels = c("0", "0.05", "0.10")) +
  coord_flip() + 
  annotate("text", x = 9, y = 0, size = 4, color = "black", label = "Baseline", hjust = -.1)

f3_panel_ascvd <- ggplot(
  dat %>% filter(outcome == "HF"), 
  aes(x = model_italic, y = mean_delta_cindex, color = color)
  ) +
  geom_hline(
...
f5_panel_ascvd <- ggplot(
  ...
  scale_colour_identity() +
  scale_y_continuous(expand = c(0, 0), limit = c(-0.06, 0.09), breaks = c(-0.04, 0, 0.04, 0.08), labels = c(-0.04, "0", 0.04, 0.08)) +
  coord_flip() + 
  annotate("text", x = 9, y = 0, size = 4, color = "black", label = "Baseline", hjust = -.1)

f6_panel_ascvd <- ggplot(
  dat %>% filter(outcome == "PAD"), 
  aes(x = model_italic, y = mean_delta_cindex, color = color)
  ) +
  geom_hline(
...
f7_panel_ascvd <- ggplot(
  ...
  scale_colour_identity() +
  scale_y_continuous(expand = c(0, 0), limit = c(-0.16, 0.18), breaks = c(-0.14, -0.07, 0, 0.07, 0.14), labels = c(-0.14, "", "0", "", 0.14)) +
  coord_flip() + 
  annotate("text", x = 9, y = 0, size = 4, color = "black", label = "Baseline", hjust = -.1)

f8_panel_ascvd <- ggplot(
  dat %>% filter(outcome == "VTE"), 
  aes(x = model_italic, y = mean_delta_cindex, color = color)
  ) +
  geom_hline(
  ...
  scale_colour_identity() +
  scale_y_continuous(expand = c(0, 0), limit = c(-0.03, 0.13), breaks = c(0, 0.06, 0.12), labels = c("0", 0.06, 0.12)) +
  coord_flip() + 
  annotate("text", x = 9, y = 0, size = 4, color = "black", label = "Baseline", hjust = -.1)

f9_panel_ascvd <- ggplot(
  dat %>% filter(outcome == "CVDeath"), 
  aes(x = model_italic, y = mean_delta_cindex, color = color)
  ) +
  geom_hline(
...
models <- c(
  "SCORE2", "PANEL", "PANELPRS", "PANELMet", "PANELPro", 
  "PANELPRSMet", "PANELPRSPro", "PANELMetPro", "PANELPRSMetPro")

dat <- cindex_raw %>%
  filter(outcome != "Major adverse cardiovascular events" & model %in% models) %>%
  group_by(outcome, fold) %>% 
  mutate(delta_cindex = cindex - cindex[model == "SCORE2"]) %>%
  ungroup() %>%
  group_by(outcome, model) %>%
  summarise(
    mean_delta_cindex = mean(delta_cindex, na.rm = TRUE),
  ...
  mutate(
    model = factor(
      model, levels = rev(models),
      labels = rev(c("SCORE2", "PANEL", "+PRS", "+MetScore", "+ProScore", "+PRS +MetScore", "+PRS +ProScore", "+MetScore +ProScore", "+PRS +MetScore +ProScore"))),
    model_italic = ifelse(!model %in% c("SCORE2", "PANEL"), glue("*{model}*"), glue("{model}")),
    model_italic = factor(model_italic, levels = rev(c("SCORE2", "PANEL", "*+PRS*", "*+MetScore*", "*+ProScore*", "*+PRS +MetScore*", "*+PRS +ProScore*", "*+MetScore +ProScore*", "*+PRS +MetScore +ProScore*"))),
    outcome = factor(
      outcome, 
      levels = c("Coronary artery diseases", "Stroke", "Heart failure", "Atrial fibrillation", "Ventricular arrhythmias", "Peripheral artery diseases", "Abdominal aortic aneurysm", "Vein thrombosis", "Cardiovascular death"),
      labels = c("CAD", "Stroke", "HF", "AF", "VA", "PAD", "AAA", "VTE", "CVDeath")
      ),
    color = ifelse(model == "SCORE2", "white", "#F39B7FCC")
  )

#### Plotting ####
f1_panel_score2 <- ggplot(
  dat %>% filter(outcome == "CAD"), 
  aes(x = model_italic, y = mean_delta_cindex, color = color)
  ) +
  geom_hline(
...
# Each column
col1 <- wrap_elements(
 f1_panel_ascvd + f1_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))

col2 <- wrap_elements(
  f2_panel_ascvd + f2_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))

col3 <- wrap_elements(
  f3_panel_ascvd + f3_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))

col4 <- wrap_elements(
  f4_panel_ascvd + f4_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))

col5 <- wrap_elements(
  f5_panel_ascvd + f5_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))

col6 <- wrap_elements(
 f6_panel_ascvd + f6_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))

col7 <- wrap_elements(
  f7_panel_ascvd + f7_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))

col8 <- wrap_elements(
  f8_panel_ascvd + f8_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))

col9 <- wrap_elements(
  f9_panel_ascvd + f9_panel_score2 +
    plot_layout(nrow = 2, heights = c(1, 1))
  ) + theme(plot.margin = unit(c(t = 0, r = 0, b = 0, l = 0), "cm"))
...
showtext_auto(enable = T)
font_add("Arial", regular = "Arial.ttf")
ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_ASCVD_SCORE2.pdf"), plot = delta_forest_pool, width = 16, height = 8, unit = "in", dpi = 500, device = "pdf")
showtext_auto(enable = F)

ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_ASCVD_SCORE2.png"), plot = delta_forest_pool, width = 16, height = 8, unit = "in", dpi = 300, device = "png")

ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_ASCVD_SCORE2.tiff"), plot = delta_forest_pool, width = 16, height = 8, unit = "in", dpi = 300, device = "tiff")

```

------------------------------------------------------------------------------------

# Multiomics vs single omics
...
ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_subgroup.pdf"), plot = forest_pool, width = 32, height = 18, unit = "in", dpi = 300, device = "pdf")

ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_subgroup.tiff"), plot = forest_pool, width = 32, height = 18, unit = "in", dpi = 300, device = "tiff")

ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_subgroup.png"), plot = forest_pool, width = 32, height = 18, unit = "in", dpi = 300, device = "png")
...
#### Data preparation ####
cindex <- read_csv(str_c(getwd(), "/data/lasso_cindex_summary_df.csv"), show_col_types = F)
...
ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_Lasso.tiff"), plot = cindex_forest_pool, width = 16, height = 9, unit = "in", dpi = 300, device = "tiff")

ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_Lasso.pdf"), plot = cindex_forest_pool, width = 16, height = 9, unit = "in", dpi = 300, device = "pdf")

ggsave(str_c(getwd(), "/results/Figure/Performance_comparison_Lasso.png"), plot = cindex_forest_pool, width = 16, height = 9, unit = "in", dpi = 300, device = "png")
...
cindex_by_model_lasso <- cindex_all %>%
  group_by(predictor, model) %>%
  summarise(mean_cindex = mean(mean_cindex)) 

write_tsv(cindex_all, file = str_c(getwd(), "/results/Table/Source data/cindex_lasso.tsv"))



cindex_by_model <- cindex_by_model_cph %>%
  left_join(cindex_by_model_lasso, by = c("predictor", "model"), suffix = c("_cph", "_lasso")) %>%
  mutate(mean_cindex_diff = mean_cindex_cph - mean_cindex_lasso)

write_csv(cindex_by_model, file = str_c(getwd(), "/results/Table/Comparison_cindex_cph_lasso.csv"))
...
#### Data preparation ####
folder_path <- "your path/data/Pred"
...
combined_data <- file_list %>%
  map_df(~ {
    file_name <- basename(.x)  # 提取文件名
    model_name <- str_remove(file_name, "_test_pred.csv")  # 去掉 "_test_pred.csv" 部分
    model <- model_mapping[model_name]  # 根据映射获取模型名称
...
cal_dca_pool <- wrap_plots(
  wrap_elements(cal_dca_pool) + plot_spacer() + wrap_elements(ggpubr::get_legend(legend)) + plot_spacer() + 
    plot_layout(ncol = 4, widths = c(1, 0.025, 0.1, 0.05))
  )

ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_AgeSex.pdf"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "pdf")

ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_AgeSex.tiff"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "tiff")

ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_AgeSex.png"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "png")
...
ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_Clin.pdf"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "pdf")

ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_Clin.tiff"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "tiff")

ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_Clin.png"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "png")
...
ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_PANEL.pdf"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "pdf")

ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_PANEL.tiff"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "tiff")

ggsave(str_c(getwd(), "/results/Figure/Model_calibration_decision_curve_PANEL.png"), plot = cal_dca_pool, width = 12, height = 15, unit = "in", dpi = 300, device = "png")
...
dat_text <- dat_shap %>%
  ...
  arrange(Sub.Group, biomarker) %>%
  group_by(Sub.Group) %>%
  do(bind_rows(., tibble(biomarker = "", Sub.Group = unique(.$Sub.Group)))) %>% # 使用 add_row() 在每组的最后一个元素后添加空行
  ungroup() %>%
  mutate(id = row_number() + 1) # 添加 id 列
...
beeswarm_met_cad <- ggplot(dat %>% filter(outcome == "cad")) +
  ...
  geom_textpath( # Biomarker labels
    data = dat_text_v1, 
    aes(x = id, label = biomarker, y = 0.27), # ylim 最大值*0.3
    color = "black", size = 1.5, 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_textpath( # Subgroup labels
    data = dat_text_v2, 
    aes(x = id, label = Sub.Group, y = 0.54), # ylim 最大值*0.6
    color = "black", size = 2, fontface = "bold", 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.26, yend = 0.26), # ylim 最大值*0.3-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.53, yend = 0.53), # ylim 最大值*0.6-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_hline(
    yintercept = 0,
  ...
  geom_hline(
    yintercept = -0.45,
    color = "grey50", linetype = "dashed", linewidth = 0.5 # ylim 最小值*0.5
    ) +
  ...
  annotate("text", label = "CAD", x = -Inf, y = -0.9, size = 8, colour = "black") # ylim 最小值

# 减少饼图周围空白：https://stackoverflow.com/questions/38034560/reduce-margins-around-ggplot2-pie-chart
...
beeswarm_met_hf <- ggplot(dat %>% filter(outcome == "hf")) +
  ...
  geom_textpath( # Biomarker labels
    data = dat_text_v1, 
    aes(x = id, label = biomarker, y = 0.36), # ylim 最大值*0.3
    color = "black", size = 1.5, 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_textpath( # Subgroup labels
    data = dat_text_v2, 
    aes(x = id, label = Sub.Group, y = 0.72), # ylim 最大值*0.6
    color = "black", size = 2, fontface = "bold", 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.35, yend = 0.35), # ylim 最大值*0.3-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.71, yend = 0.71), # ylim 最大值*0.6-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_hline(
    yintercept = 0,
...
beeswarm_met_va <- ggplot(dat %>% filter(outcome == "va")) +
  ...
  geom_textpath( # Biomarker labels
    data = dat_text_v1, 
    aes(x = id, label = biomarker, y = 0.42), # ylim 最大值*0.3
    color = "black", size = 1.5, 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_textpath( # Subgroup labels
    data = dat_text_v2, 
    aes(x = id, label = Sub.Group, y = 0.84), # ylim 最大值*0.6
    color = "black", size = 2, fontface = "bold", 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.41, yend = 0.41), # ylim 最大值*0.3-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.83, yend = 0.83), # ylim 最大值*0.6-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_hline(
    yintercept = 0,
...
beeswarm_met_pad <- ggplot(dat %>% filter(outcome == "pad")) +
  ...
  geom_textpath( # Biomarker labels
    data = dat_text_v1, 
    aes(x = id, label = biomarker, y = 0.45), # ylim 最大值*0.3
    color = "black", size = 1.5, 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_textpath( # Subgroup labels
    data = dat_text_v2, 
    aes(x = id, label = Sub.Group, y = 0.9), # ylim 最大值*0.6
    color = "black", size = 2, fontface = "bold", 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.44, yend = 0.44), # ylim 最大值*0.3-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.89, yend = 0.89), # ylim 最大值*0.6-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_hline(
    yintercept = 0,
...
beeswarm_met_aaa <- ggplot(dat %>% filter(outcome == "aaa")) +
  ...
  geom_textpath( # Biomarker labels
    data = dat_text_v1, 
    aes(x = id, label = biomarker, y = 0.66), # ylim 最大值*0.3
    color = "black", size = 1.5, 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_textpath( # Subgroup labels
    data = dat_text_v2, 
    aes(x = id, label = Sub.Group, y = 1.32), # ylim 最大值*0.6
    color = "black", size = 2, fontface = "bold", 
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.65, yend = 0.65), # ylim 最大值*0.3-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 1.31, yend = 1.31), # ylim 最大值*0.6-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_hline(
    yintercept = 0,
...
dat_text <- dat_shap %>%
  ...
  group_by(Panel) %>%
  do(bind_rows(., tibble(biomarker = "", Panel = unique(.$Panel)))) %>% # 使用 add_row() 在每组的最后一个元素后添加空行
  ungroup() %>%
  mutate(id = row_number() + 1) # 添加 id 列
...
beeswarm_pro_cad <- ggplot(dat %>% filter(outcome == "cad")) +
  ...
  geom_textpath( # Biomarker labels
    data = dat_text_v1,
    aes(x = id, label = biomarker, y = 0.09), # ylim 最大值*0.3
    color = "black", size = 1.5,
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_textpath( # Subgroup labels
    data = dat_text_v2,
    aes(x = id, label = Panel, y = 0.18), # ylim 最大值*0.6 
    color = "black", size = 2, fontface = "bold",
    angle = 90, hjust = 0, vjust = 0.5
    ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.08, yend = 0.08), # ylim 最大值*0.3-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_segment(
    data = dat_subgroup_lines,
    aes(x = start_id, xend = end_id, y = 0.17, yend = 0.17), # ylim 最大值*0.6-0.1
    color = "grey50", linewidth = 0.25
  ) +
  geom_hline(
    yintercept = 0,
  ...
  annotate("text", label = "CAD", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
beeswarm_pro_stroke <- ggplot(dat %>% filter(outcome == "stroke")) +
  ...
  annotate("text", label = "Stroke", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
beeswarm_pro_hf <- ggplot(dat %>% filter(outcome == "hf")) +
  ...
  annotate("text", label = "HF", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
beeswarm_pro_af <- ggplot(dat %>% filter(outcome == "af")) +
  ...
  annotate("text", label = "AF", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
beeswarm_pro_va <- ggplot(dat %>% filter(outcome == "va")) +
  ...
  annotate("text", label = "VA", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
beeswarm_pro_pad <- ggplot(dat %>% filter(outcome == "pad")) +
  ...
  annotate("text", label = "PAD", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
beeswarm_pro_aaa <- ggplot(dat %>% filter(outcome == "aaa")) +
  ...
  annotate("text", label = "AAA", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
beeswarm_pro_vte <- ggplot(dat %>% filter(outcome == "vt")) +
  ...
  annotate("text", label = "VTE", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
beeswarm_pro_cvdeath <- ggplot(dat %>% filter(outcome == "cvd_death")) +
  ...
  annotate("text", label = "CVDeath", x = -Inf, y = -0.3, size = 8, colour = "black") # ylim 最小值
...
legend_1 <- ggplot(dat_legend %>% filter(outcome == "cad")) +
  ...
  scale_colour_gradientn( # Biomarker levels (truncated)
    colors = rev(c("#A90C38FF", "#DB4446FF", "#F78171FF", "#FFBFB2FF", "#FFFFFFFF", "#B4D2E9FF", "#7BA8CCFF", "#5180ACFF", "#2E5A87FF")),
    # colors = rev(c("#001889FF", "#5F008CFF", "#91008DFF", "#B62485FF", "#D24E71FF", "#E4774DFF", "#EDA200FF", "#E9CF00FF", "#DAFF47FF")),
    # colors = c("#2E4F79FF", "#1A6886FF", "#028190FF", "#1D9997FF", "#46B09BFF", "#70C69EFF", "#9CDAA1FF", "#CAEDA7FF", "#F9FFAFFF"),
    # colors = c("#704D9EFF", "#9A51A7FF", "#BC5AA9FF", "#D868A3FF", "#ED7C97FF", "#F6978AFF", "#F9B282FF", "#F8CD86FF", "#F3E79AFF"),
    values = rescale(c(-4, -1, -0.75, -0.5, -0.25, 0, 0.25, 0.5, 0.75, 1, 4)),
    breaks = c(-4, 4),
    labels = c("Low", "High"),
